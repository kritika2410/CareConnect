...
public class ParentEditProfile extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (userId > 0) {
                ...
                String[] projection = {DBHelper.COLUMN_NAME, DBHelper.COLUMN_EMAIL, DBHelper.COLUMN_IMAGE, DBHelper.COLUMN_DESCRIPTION};
                ...
                if (cursor.moveToFirst()) {
                    ...
                    @SuppressLint("Range") byte[] image = cursor.getBlob(cursor.getColumnIndex(DBHelper.COLUMN_IMAGE));
        ...
        private void updateProfile() {
            ...
            String whereClause = "parent_id = ?";
            String[] whereArgs = new String[] { String.valueOf(userId) };
            int numRowsUpdated = database.update("parent", values, whereClause, whereArgs);
